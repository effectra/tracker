 ...
 * Class IpGeoLocation
 *
 * This class provides methods to interact with the ipgeolocation.io API and access various attributes
 * from the API response.
 *
 */
class IpGeoLocation extends Attribute
{
    /**
     ...
     * @var string
     */
    protected string $service_url = "https://api.ipgeolocation.io/ipgeo";
    ...
    {
        try {
            $url = "{$this->service_url}?ip={$ip}&apiKey={$apiKey}";
